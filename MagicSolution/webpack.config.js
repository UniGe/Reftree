...
module.exports = [
    ...
    extend(0, {
        entry: {
            'babel-polyfill': 'babel-polyfill',
            'example': './Views/0/Js/react/example.jsx',
        }
    }),
    extend(3, {
        plugins: [
            new CopyWebpackPlugin(
                [
                    //{
                    //    from: 'node_modules/cad-viewer-package/cad-viewer.min.js',
                    //}
                ],
            )
        ],
        entry: {
            'tpsi': './Views/3/Js/react/tpsi.jsx',
            'tpsi-sync': './Views/3/Js/react/tpsi-sync.jsx',
        }
    })
];