...
//***********************************BEGIN Slimscroller *****************************		
	$('.scroller').each(function () {
		...
		//$(this).closest(".slimScrollDiv").addClass("page-sidebar");
		//$(this).closest(".slimScrollDiv").css("margin-top",0);
	});
...
//***********************************BEGIN Function calls *****************************	
    ...
    } catch (e) { console.log("problems in try catch block at line 355 in core.js of webarch...") }
//***********************************BEGIN Function calls *****************************	
...
function calculateHeight(e) {
	if (!e)
		e = {};
	//PATCH D.T adjust page-content height so that it fits to page, refresh kendo elements
	$('.page-content').css("min-height", window.innerHeight + "px");
	if (!e.menuItemClick)
