            ...
            customizeModal({
                ...
                model: {
                    ...
                    properties: {
                        ...
                        onRenderCallback: {
                            title: "JS function name to call on render",
                            type: "string",
                            options: {
                                grid_columns: 3
                            }
                ...
                if (rowData.Settings) {
                    ...
                    if (settings && !settings.onRenderCallback) {
                        settings.onRenderCallback = "";
                    }
                    $.map(settings.steps, function (step, k) {
                        if (step.fields) {
                            $.map(step.fields, function (field, _k) {
                                settings.steps[k].fields[_k] = $.extend(true, {
                                    ColumnName: "",
