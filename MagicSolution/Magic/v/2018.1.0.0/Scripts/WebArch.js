...
function initMenu() {
    ...
    jQuery('.page-sidebar li > a').on('click', function (e) {
		...
		//core.js of webarch
		calculateHeight({ menuItemClick: true });
        e.preventDefault();
    });
}
...
$(window).click(function (e) {
    var $menu = $("#main-menu");
    if ($menu.hasClass("mini") || window.outerWidth > 768 && $('html').is('.top-menu')) {
...
//used in the expiration password procedure 
function removeOuterComponents() {
	$(".header.navbar.navbar-inverse ").remove();
	$("#main-menu").remove();
