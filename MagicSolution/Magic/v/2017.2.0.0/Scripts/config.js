(function () {
    var kendoPath = window.includesVersion + "/Magic/kendo/2016.1.226/js/",
        angularDirectivesPath = window.includesVersion + "/Magic/Views/Js/Directives/",
        devExpressPath = window.includesVersion + "/Magic/DevExtreme/Lib/js/",
        angularVersion = "angular-1.4.6/"
    ...
    requirejs.config({
        ...
        baseUrl: window.includesVersion + "/Magic/v/" + window.applicationVersion + "/Scripts",
        map: {
            "*": {
                'kendo.core.min': kendoPath + "kendo.all.min.js"
            }
        },
        paths: {
            ...
            "angular-ui-select": "angular-3rd-party/select.min", //loadCss(["select"]);
