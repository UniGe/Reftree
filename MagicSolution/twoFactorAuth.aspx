<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="twoFactorAuth.aspx.cs" Inherits="MagicSolution.syncTwoFactorAuthSecret" %>
        ...
        <div>
            <div class="login" style="background-color: transparent !important">
	            ...
	            <div class="content container" style="padding-bottom: 25px; background: rgba(0,0,0,0.4);">
                    ...
                    <asp:Image runat="server" ID="QRCode" class="img-responsive" alt="QRCode" Visible="false" />
                    <div style="color:white; text-align:center">
                        <asp:Label runat="server" ID="ManualEntryKey" title="Manual Entry Key" Visible="false" />
                    </div>
                    <div style="color:white; text-align:center">
                        <asp:Label runat="server" ID="Description" title="Description" Visible="false" />
                    </div>
