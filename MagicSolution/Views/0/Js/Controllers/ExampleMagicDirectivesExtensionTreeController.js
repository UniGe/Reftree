define(["MagicSDK"], function (MF) {
    ...
    return {
        ...
        js: function (controller) {
			...
			MF.api.get({
				storedProcedureName: "Custom.Sample_GetTreeName",
				data: {
				...
				window.showActions__ = function (e) {
					...
					if (!window.treeActionSP) {
						kendoConsole.log("treeActionSP window variable has not been set in AdminAreaCustomizations.js!");
						return;
					}
					openActionsTooltip({
						requestOptions: {
						...
						storeProcedureName: window.treeActionSP,
