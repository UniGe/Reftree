define([ //requireJs deps    
    ...
    return angular
        .module("ReftreePortalViewer", ["ui.bootstrap", "easyMap" ,    
        ])
        .controller("ReftreePortalViewerController", [
            "config",
            "$scope",
            "$timeout",     
            "$uibModal",
            ...
            function (config, $scope, $timeout, $uibModal ,$sce,) {
                ...
                self.onLoadAsset = function onLoadAsset() {
                    MF.api.get({
                        storedProcedureName: "core.AS_SP_ASSET_PORTAL_GET_XML",
                ...
                self.onOpenPreView = function onOpenPreView() {
                    $uibModal.open({
                        templateUrl: window.includesVersion + '/Views/3/Templates/ReftreePortalViewer.html', //sTemplate, // loads the template
                        animation: true,
                        ...
                        controller: ("previewController", ["$scope", "$uibModalInstance", function (
                            ...
                            $scope.cancel = function () {
                                if ($scope.$parent.rpv.ContainerAll['all']) {
