...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                <div id="dashboardtabstrip" style="display:none;">
                            <ul>
    ...
    $.getScript(window.includesVersion + "/Magic/v/" + window.applicationVersion + "/Scripts/dashboard.js")
        .done(function () {
            apply_style("/Views/1/Styles/mybizdashboard.css");  //applica css
            $("#spanbig").text("Dashboard");
            $("#dashboardtabstrip").show();
            $("#dashboardtabstrip").kendoTabStrip();
            //Date per i Grafici
