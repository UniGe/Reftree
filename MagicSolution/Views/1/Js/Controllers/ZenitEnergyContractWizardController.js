(function () {
	...
	var angular,
		app,
		controllerName = "ZenitEnergyContractWizard";
				...
				function (config, $scope, $timeout) {
					...
					self.loadOffers = function () {
						GetDropdownValues("usp_PhoneLineOffer_Drop_Z", "ID", "Description", "Zenit", 1, self.filter
							, true, { wizardCode: "EnergyCRMZenit" })
					...
					self.gridFilter = {
						type: "customFilter", logic: 'AND', filters: [
							{ field: "T_PhoneContractStatus_ID", operator: "eq", value: "18", type: "customFilter" },
							{ field: "OperatorUser_ID", operator: "eq", value: "[userId]", type: "customFilter" },
							{ field: "EnergyContract", operator: "eq", value: "1", type: "customFilter" }

						]
					};
					$scope.$watch("zecw.offer", function () {
